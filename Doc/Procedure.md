...
![raw](https://github.com/issy-kazu3/Battery-Modeling-Workflow-Part1-Parameter-Identification/blob/main/images/trim_rawdata.png)
 
As a preprocessing step, the initial SOC adjustment section was removed,correct the data to one cell per cell and the OCV value for each SOC condition was added manually.
